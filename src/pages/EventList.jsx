  ...
  return (
    <div className="grid gap-6">
      <section className="rounded-lg bg-slate-950 p-6 text-white sm:p-8">
        ...
        <h1 className="mt-2 max-w-3xl text-3xl font-black sm:text-5xl">Find campus events, register fast, and walk in with your QR pass.</h1>
        <p className="mt-4 max-w-2xl text-slate-300">Browse approved events with live seat counts, categories, venue details, and instant registration.</p>
      </section>
