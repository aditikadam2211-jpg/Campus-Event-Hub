...
export default function EventList() {
  ...
  return (
    <div className="grid gap-6">
      <section className="rounded-lg bg-maroon p-6 text-white sm:p-8">
        ...
        <p className="mt-4 max-w-2xl text-slate-300"> Discover campus events, explore clubs, check seat availability, register instantly, and manage your registrations—all in one place.</p>
      </section>
